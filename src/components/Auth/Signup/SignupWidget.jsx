      ...
      <div className="input-area">
        <div className="flex sm:flex-row flex-col space-y-5 sm:space-y-0 sm:space-x-5 rtl:space-x-reverse mb-5">
          <div className="h-full">
            <InputCom
              ...
              name="fname"
              type="text"
              inputClasses="h-[50px] rounded-lg"
              value={fname}
        ...
        <div className="input-item mb-5">
          <InputCom
            ...
            name="email"
            type="email"
            inputClasses="h-[50px] w-full rounded-lg"
            value={email}
        ...
        {phone_number_required === '1' && (
          <div className="input-item mb-5 relative">
            <InputCom
              ...
              name="phone"
              type="text"
              inputClasses="h-[50px] placeholder:capitalize pl-20 rounded-lg"
              value={phone}
        ...
        <div className="forgot-password-area mb-7">
          <div className="remember-checkbox flex items-center space-x-2.5 rtl:space-x-reverse">
            <button
              onClick={rememberMe}
              type="button"
              className="w-5 h-5 text-qyellow flex justify-center items-center border border-light-gray"
            >
              {checked && (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="signin-area mb-5">
          <div className="flex justify-center">
            <button
              ...
              type="button"
              disabled={!checked}
              className="bg-qyellow rounded-lg disabled:bg-opacity-50 disabled:cursor-not-allowed  w-full h-[50px] font-semibold flex justify-center bg-purple items-center"
            >
        ...
        <div className="flex gap-5">
          <>
            {googleUrl && (
              ...
              <a
                href={`${googleUrl}`}
                className="w-full p-3px rounded-lg border border-qgray-border h-[50px] flex space-x-3  justify-center bg-[#FAFAFA] items-center mb-2"
              >
                <svg
                  width="19"
                  height="20"
                ...
                <span className="text-[15px] text-qgraytwo font-normal">
                  Google
                </span>
              </a>
          ...
          <>
            {faceBookUrl && (
              ...
              <a
                href={`${faceBookUrl}`}
                className="w-full p-3 rounded-lg border border-qgray-border text-white h-[50px] flex space-x-3  justify-center bg-[#38599A] items-center mb-2"
              >
