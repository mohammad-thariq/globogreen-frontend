...
export default function Signup() {
  ...
  return (
    // <Layout childrenClasses="pt-0 pb-0 mt-[90px]">
    ...
    //           </div>
    //         ) : signupView ? (
    //           <div className="lg:w-[572px] w-full lg:h-auto bg-white flex flex-col justify-center sm:p-10 p-5 rounded-lg border border-[#E0E0E0]">
    //             <SignupWidget />
    //           </div>
    //         ) : (
    //           ""
      ...
      <div className="login-page-wrapper w-full py-10 ">
        <div className="container-x mx-auto">
          <div className="flex h-full items-center justify-center">
            {verify ? (
              <div className="lg:w-[572px] w-full lg:h-[700px] bg-white  sm:p-10 p-5  border border-[#E0E0E0]">
                <VerifyWidget />
              </div>
            ) : signupView ? (
              <div className="lg:w-[572px] w-full lg:h-auto bg-white  sm:p-10 p-5 rounded-lg border border-[#E0E0E0]">
                <SignupWidget />
              </div>
            ) : (
              ""
