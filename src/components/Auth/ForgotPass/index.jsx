...
export default function ForgotPass() {
  ...
  return (
    <Layout childrenClasses="pt-[70px] pb-0">
      <div className="login-page-wrapper w-full py-10">
        <div className="container-x mx-auto">
          <div className="flex h-full items-center justify-center">
            <div className="lg:w-[572px] w-full h-[400px] rounded-md bg-white flex flex-col justify-center sm:p-10 p-5 border border-[#E0E0E0]">
              {forgotUser ? (
