  ...
  return (
    <div className="w-full">
      ...
      <div className="input-area">
        ...
        <div className="signin-area mb-3.5">
          <div className="flex justify-center">
            <button
              onClick={doLogin}
              type="button"
              className=" bg-qyellow mb-6 text-sm text-white w-full h-[50px] font-semibold flex justify-center bg-purple items-center rounded-lg"
            >
        ...
        <div className="flex gap-5">
          <>
            {googleUrl && (
              <a
                href={`${googleUrl}`}
                className="w-full border border-qgray-border h-[50px] flex space-x-3  justify-center bg-[#FAFAFA] items-center rounded-lg"
              >
                <svg
                  width="19"
                  height="20"
          ...
          <>
            {faceBookUrl && (
              <a
                href={`${faceBookUrl}`}
                className="w-full border border-qgray-border text-white h-[50px] flex space-x-3  justify-center bg-[#38599A] items-center rounded-lg"
              >
                <svg
        ...
        <div className="signup-area mt-5 flex justify-center">
