        ...
        <div className="products-page-wrapper w-full">
          <div className="container-x mx-auto">
            ...
            <div className="w-full lg:flex lg:space-x-[30px] rtl:space-x-reverse">
              <div className="lg:w-[270px] mt-[100px] z-0">
                <ProductsFilter
                ...
                {response.data && response.data.shopPageSidebarBanner && parseInt(response.data.shopPageSidebarBanner.status) === 1 && (
                  <div
                    ...
                    className="w-full mb-[50px] hidden py-[35px] ltr:pl-[40px] rtl:pr-[40px] group lg:block h-[295px] relative"
                  >
              ...
              <div className="flex-1">
                {response.data && response.data.products.data.length > 0 ? (
                  <div className="w-full">
                    <div className="products-sorting rounded-lg mt-[100px] w-full bg-white md:h-[70px] flex md:flex-row flex-col md:space-y-0 space-y-5 md:justify-between md:items-center p-[30px] mb-[40px]">
                      <div>
