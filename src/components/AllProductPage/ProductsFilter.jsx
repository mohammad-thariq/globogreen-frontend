...
export default function ProductsFilter({
  ...
  return (
    <>
      <div
        className={`filter-widget rounded-lg w-full fixed lg:relative left-0 top-0 h-screen z-10 lg:h-auto overflow-y-scroll lg:overflow-y-auto bg-white px-[30px] pt-[40px] ${className || ""
