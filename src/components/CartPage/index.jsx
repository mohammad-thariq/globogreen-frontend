  ...
  return (
    <>
      {getCarts && getCarts.length === 0 ? (
        <div className="cart-page-wrapper w-full mt-[50px]">
        ...
        <div className="cart-page-wrapper w-full bg-white pb-[60px] mt-[60px]">
            ...
            <div className="container-x mx-auto">
              ...
              <div className="w-full sm:flex justify-between">
                <div className="flex space-x-4 rtl:space-x-reverse items-center">
                  ...
                  <Link href="/cart">
                    <div className="w-[140px] h-[50px] bg-[#F6F6F6] flex justify-center items-center cursor-pointer rounded-xl hover:bg-[#23D24F] hover:text-white">
                  ...
                  <Link href="/checkout">
                    <div className="w-[300px] h-[50px] black-btn flex justify-center items-center cursor-pointer rounded-xl hover:bg-[#23D24F]">
                      <span className="text-sm font-semibold">
