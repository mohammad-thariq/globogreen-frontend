        ...
        >
          <div className="w-full px-5 mt-5 mb-4">
            <div className="flex justify-between items-center">
              <div className="flex space-x-5 items-center">
                ...
                {auth == null ?   
                <Link href="/login">
                    <span className="flex items-start gap-[10px] cursor-pointer">
                      <ThinPeople />
                     Login
                    </span>
          ...
          <div className="w-full mt-5 px-5 flex items-center space-x-3">
            <span
              ...
              className={`text-base font-semibold cursor-pointer  ${tab === "category" ? "text-qblack" : "text-qgray"
                }`}
            >
            ...
            <span
              onClick={() => setTab("menu")}
              className={`text-base font-semibold cursor-pointer ${tab === "menu" ? "text-qblack" : "text-qgray"
                }`}
            >
          ...
          {tab === "category" ? (
            ...
            <div className="menu-item mt-5 w-full">
              <ul className="categories-list">
                ...
                {auth &&
                <li className="category-item">
                    <div className="flex justify-between text-white bg-[#FE4949] items-center px-5 h-12 hover-bg-qyellow transition-all duration-300 ease-in-out cursor-pointer" onClick={handleSignOut}>
                      <div className="flex items-center space-x-6">
                        <span className="text-sm font-400 capitalize">Sign Out</span>
                      </div>
                      <div>
                        <span>
                          <svg
