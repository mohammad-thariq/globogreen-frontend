      ...
      >
        ...
        >
          <div className="w-full">
            <div className="w-full md:h-[460px] h-[300px] border border-qgray-border flex justify-center items-center overflow-hidden relative mb-3 relative">
              <Image
                layout="fill"
              ...
              />
              {product.offer_price && (
                <div className="w-[60px] h-[60px] rounded-full bg-qyellow text-qblack flex justify-center items-center text-xl font-medium absolute left-[30px] top-[30px]">
          ...
          <div className="product-details w-full mt-10 lg:mt-0">
            ...
            >
              ...
              {offerPrice && (
                <span
                  suppressHydrationWarning
                  className="offer-price text-[#23D24F] font-600 text-[20px] ml-2"
                >
                  <CheckProductIsExistsInFlashSale
                    id={product.id}
                    price={offerPrice}
            ...
            <div className="p-3 bg-qyellowlow/10 flex items-center space-x-2 mb-[30px] w-fit rounded-xl">
            ...
            >
              <div className="w-[120px] h-full px-[26px] flex items-center border border-qgray-border rounded-xl">
                <div className="flex justify-between items-center w-full">
                  <button
                    onClick={decrement}
                    type="button"
              ...
              <div className="w-[60px] h-full flex justify-center items-center border border-qgray-border rounded-xl hover:bg-[#23D24F]">
                {/*<button type="button">*/}
                {/*  <span>*/}
                {/*    <svg*/}
                {/*        width="24"*/}
              ...
              <div className="flex-1 h-full ">
                <button
                  onClick={addToCard}
                  type="button"
                  className="black-btn text-sm font-semibold w-[55%] h-full rounded-xl hover:bg-[#23D24F]"
                >
