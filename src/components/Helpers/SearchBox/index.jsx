...
export default function SearchBox({ className }) {
  ...
  return (
    <>
      <div
        className={`w-full h-full flex items-center bg-white rounded-s-xl  ${
          className || ""
        }`}
        style={{maxWidth: "90%", marginLeft: "16px"}}
      >
        ...
        <button
          ...
          className="search-btn w-[93px] rounded-tr-xl rounded-br-xl h-full text-sm font-600 "
          type="button"
        >
