...
export default function ProductCardStyleOne({ datas }) {
  ...
  const [imgSrc, setImgSrc] = useState(datas.image);
  // const loadImg = (value) => {
  //   // const time = 3000;
  //   // setTimeout(() => {
  //   //   setImgSrc(value);
  ...
  return (
    <div className="main-wrapper-card relative">
      <div
        className="product-card-one w-full h-[400px] p-5px bg-white relative group overflow-hidden rounded-2xl"
        style={{ boxShadow: "rgba(0, 0, 0, 0.18) 0px 2px 4px" }}
      >
        <div className="product-card-img w-full h-[250px] -mt-2">
          <div
          ...
          >
            ...
            /> */}
            {imgSrc ? <img src={imgSrc} className="w-[160px] h-[180px] object-contain" alt="" /> : <img src="/assets/images/spinner.gif" className="w-10 h-10" alt="" />}
          </div>
        </div>
        <div className="product-card-details p-[30px] relative">
          ...
          <p className="price">
            <span
              ...
              className={`main-price  font-600 text-[13px] ${offerPrice ? "line-through text-qgray" : null
                }`}
            >
              {offerPrice ? (
            ...
            {offerPrice && (
              <span
                suppressHydrationWarning
                className="offer-price font-600 text-[16px] ml-2"
              >
                <CheckProductIsExistsInFlashSale
                  id={datas.id}
                  price={offerPrice}
        ...
        <div className="quick-access-btns flex flex-col space-y-2">
          ...
          <button
            className=" absolute group-hover:right-4 -right-10 top-20  transition-all duration-300 ease-in-out"
          ...
          >  <span className="hover:bg-qyellow w-10 h-10 flex text-black hover:text-white justify-center items-center transition-all duration-300 ease-in-out hover-bg-qyellow bg-primarygray rounded">
              <ThinBag className='fill-current' fill />
            </span>
          </button>
          {!arWishlist ? (
            <button
