...
export default function ProductCardRowStyleOne({ className, datas }) {
  ...
  return (
    <div className="main-wrapper-card relative">
      <div
        data-aos="fade-left"
        className={`product-row-card-style-one  w-full lg:h-[250px] h-[200px] bg-white group relative overflow-hidden rounded-2xl ${className || ""
          }`}
            ...
            <div>
              ...
              <p className="price mb-[26px]">
                <span
                  ...
                  className={`main-price  font-600 text-[13px] ${offerPrice ? "line-through text-qgray" : "line-through text-qgray"
                    }`}
                >
                  {offerPrice ? (
                ...
                {offerPrice && (
                  <span
                    suppressHydrationWarning
                    className="offer-price text-[#000] font-600 text-[18px] ml-2"
                  >
                    <CheckProductIsExistsInFlashSale
                      id={datas.id}
                      price={offerPrice}
