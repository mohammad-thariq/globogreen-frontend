        ...
        {ads && announcment && parseInt(announcment.status) === 1 && (
          <div className="w-full h-full flex fixed left-0 top-0 justify-center z-40 items-center ">
            ...
            >
              ...
              <div className="md:w-[415px] w-full h-[54px] sm:flex rounded-s-2xl mt-8">
                <div className="flex-1 bg-white ltr:pl-4 rtl:pr-4 mb-2 md:mb-0 flex space-x-2 rtl:space-x-reverse items-center h-full focus-within:text-qgreen text-qblack overflow-hidden">
                  ...
                  <input
                    type="email"
                    name="email"
                    className="w-full h-full focus:outline-none text-sm placeholder:uppercase rounded-none border-transparent placeholder:text-xs placeholder:text-qblack text-qblack font-400 tracking-wider email-input"
                ...
                <button
                  ...
                  type="button"
                  className="w-[120px] h-full bg-qyellow text-qblack text-sm font-600 rounded-ee-2xl"
                >
