            ...
            <>
                ...
                >
                    <div className="container-x mx-auto h-full ">
                        <div
                            className={`sm:flex xl:space-x-[30px] md:space-x-5 rtl:space-x-reverse items-center w-full h-full  overflow-hidden rounded-xl`}
                        >
                            {bannerOne && (
                                <div data-aos="fade-right" className={`h-full sm:w-1/2 w-full `}>
                                    <div
                                        style={{
                                            backgroundImage: `url(${process.env.NEXT_PUBLIC_BASE_URL + bannerOne.image
                                                })`,
                                            backgroundSize: `cover`,
                                            backgroundRepeat: `no-repeat`,
                                            backgroundPosition: `center`
                                        }}
                                        className="w-full h-full relative sm:pl-[30px] ltr:pl-[50px] rtl:pr-[50px] py-[35px] flex flex-col justify-between group"
                                    >
                                        <div>
                            ...
                            {bannerTwo && (
                                <div data-aos="fade-left " className={`h-full sm:w-1/2 w-full`}>
                                    <div
                                        style={{
                                            backgroundImage: `url(${process.env.NEXT_PUBLIC_BASE_URL + bannerTwo.image
                                                })`,
                                            backgroundSize: `cover`,
                                            backgroundRepeat: `no-repeat`,
                                            backgroundPosition: `center`
                                                ...
                                                >
                                                    <a rel="noopener noreferrer">
                                                        <div className="cursor-pointer w-full relative  ">
                                                            <div className="inline-flex  space-x-1.5 rtl:space-x-reverse items-center relative z-1">
                                                            ...
                                                            <div className="w-[82px] transition-all duration-300 ease-in-out group-hover:h-4 h-[0px]  absolute left-0 bottom-0 z-10"></div>
                                                        </div>
                                                    </a>
                                                </Link>
                                            </div>
