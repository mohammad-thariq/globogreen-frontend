      ...
      <div className="grid xl:grid-cols-6 lg:grid-cols-5 sm:grid-cols-3 grid-cols-2 xl:gap-[30px] sm:gap-5 gap-2">
        {sallers.map((saller) => (
          ...
          >
              ...
              >
                  <a rel="noopener noreferrer flex justify-center ">
                      <div className="sm:w-[130px] sm:h-[140px] w-[140px] h-[140px] rounded-full bg-white items-center overflow-hidden mb-2 relative">
                          <Image
                              layout="fill"
